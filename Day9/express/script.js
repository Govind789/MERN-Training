...
app.post('/api/products', async(req,res)=>{
    ...
    if(!data.price || !data.title){
        ...
        const db = await fsPromises.readFile('./mydata.json',{encoding:'utf-8'});
...
app.put('/api/products/:id',async (req,res)=>{
    const Jdata = await fsPromises.readFile('./mydata.json',{encoding:'utf-8'});
...
app.delete('/api/products/:id',async(req,res)=>{
    ...
    const arr = JSON.parse(await fsPromises.readFile('./mydata.json',{encoding:"utf-8"}));
